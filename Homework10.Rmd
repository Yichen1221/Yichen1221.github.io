...
# Homework 10: Nonlinear Models and Transformation of Variables II
...
For a 28.932 year old person, $\frac{\partial\widehat{LGEARN_i}}{\partial S_i}=$`r fitb(0.086)` (Fill in with three decimal places). 
