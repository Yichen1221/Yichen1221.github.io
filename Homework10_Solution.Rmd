...
The interpretation of this value is: A one `r mcq(c(answer = "inch", "unit", "%"))` increase in height of this person will increase weight on average by 5.102 pounds, ceteris paribus. Make sure that you use reasonable height values when calculating the marginal effect.
`r unhide()`
